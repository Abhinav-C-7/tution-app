...
function createData(name, batch, phone, parent_name, fee_status) {
    return { name, batch, phone, parent_name, fee_status };
}

// 3. Your 10 Student Records
const rows = [
    createData('Rahul Sharma', 'Class 10 - A', '9876543210', 'Amit Sharma', 'Paid'),
    createData('Priya Verma', 'Class 12 - Sci', '9123456789', 'Suresh Verma', 'Pending'),
    createData('Aditya Singh', 'Class 9', '9988776655', 'Rajesh Singh', 'Paid'),
    createData('Sneha Gupta', 'Class 10 - A', '8877665544', 'Anil Gupta', 'Overdue'),
    createData('Mohammed Ayan', 'Class 11 - Com', '7766554433', 'Imran Khan', 'Paid'),
    createData('Rohan Mehta', 'Class 8', '9898989898', 'Vikram Mehta', 'Pending'),
    createData('Ishita Patel', 'Class 12 - Sci', '9000011111', 'Jignesh Patel', 'Paid'),
    createData('Kavya Reddy', 'Class 10 - B', '8555522222', 'Satish Reddy', 'Paid'),
    createData('Arjun Nair', 'JEE Batch', '7000080000', 'Mohan Nair', 'Overdue'),
    createData('Simran Kaur', 'NEET Batch', '9111122222', 'Harpreet Singh', 'Pending'),
];
